...
// You can find these icons from a library like 'lucide-react' later.
  ...
  return (
    <div className="min-h-screen bg-blue-50 font-sans">
      ...
      <header className="w-full bg-white/80 backdrop-blur-sm shadow-sm py-4 px-6 md:px-10 flex items-center justify-between sticky top-0 z-50">
        <a href="/" className="text-3xl font-extrabold text-blue-600 tracking-tight">
          MedForces
        </a>
      ...
      >
        ...
        <nav className="flex flex-col p-5 space-y-4 text-center">
            <a href="#" className="text-lg font-semibold text-gray-700 hover:text-blue-600">Start Challenges</a>
            <a href="#" className="text-lg font-semibold text-gray-700 hover:text-blue-600">Browse Questions</a>
            <a href="#" className="text-lg font-semibold text-gray-700 hover:text-blue-600">Leaderboard</a>
            <hr/>
            <a href="#" className="text-lg font-semibold text-gray-700 hover:text-blue-600">Login</a>
            <a href="#" className="w-full bg-blue-600 text-white py-2 rounded-lg text-lg font-bold hover:bg-blue-700">Sign Up</a>
        </nav>
      </div>
      ...
      <main className="w-full max-w-7xl mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Card 1: Challenges */}
          <a href="#" className="pro-card block bg-white rounded-xl shadow-md p-8 text-left">
